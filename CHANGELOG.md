...
### Release Summary
Initial release of NetBox Config Plugin. This is a **minor** release introducing basic functionality for managing Config resources in NetBox.

### Added
- Initial plugin structure with Config model
