"""
Test cases for NetBox Config Plugin REST API.
"""
...
class ConfigAPITestCase(PluginAPITestCase):
    """Test Config API endpoints."""

    @classmethod
    def setUpTestData(cls):
        """Set up test data for all tests."""
        Config.objects.create(name='API Test 1')
        Config.objects.create(name='API Test 2')
        Config.objects.create(name='API Test 3')

    def setUp(self):
        """Set up each test."""
        super().setUp()
        self.list_url_name = 'plugins-api:netbox_config_plugin-api:config-list'
        self.detail_url_name = 'plugins-api:netbox_config_plugin-api:config-detail'

    def test_list_configs(self):
        """Test GET request to list Configs."""
    ...
    def test_get_config(self):
        """Test GET request for a single Config."""
        self.add_permissions('netbox_config_plugin.view_config')
    ...
    def test_create_config(self):
        """Test POST request to create a Config."""
        self.add_permissions('netbox_config_plugin.add_config')
    ...
    def test_bulk_create_configs(self):
        ...
        for item in data:
            self.assertTrue(
                Config.objects.filter(name=item['name']).exists()
            )

    def test_update_config(self):
        """Test PATCH request to update a Config."""
        self.add_permissions('netbox_config_plugin.change_config')
    ...
    def test_delete_config(self):
        """Test DELETE request to remove a Config."""
        self.add_permissions('netbox_config_plugin.delete_config')
...
class ConfigAPIValidationTestCase(PluginAPITestCase):
