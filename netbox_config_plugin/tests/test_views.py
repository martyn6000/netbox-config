...
class ConfigViewTestCase(PluginViewTestCase):
    ...
    def setUp(self):
        """Set up each test."""
        super().setUp()
        self.base_url = 'plugins:netbox_config_plugin:config'

    def test_list_configs(self):
        """Test Config list view."""
        self.add_permissions('netbox_config_plugin.view_config')

        url = reverse('plugins:netbox_config_plugin:config_list')
    ...
    def test_view_config(self):
        ...
        url = reverse('plugins:netbox_config_plugin:config', kwargs={'pk': instance.pk})
        response = self.client.get(url)
    ...
    def test_create_config(self):
        ...
        self.add_permissions(
            'netbox_config_plugin.add_config',
            'netbox_config_plugin.view_config'
        )

        url = reverse('plugins:netbox_config_plugin:config_add')
    ...
    def test_edit_config(self):
        ...
        self.add_permissions(
            'netbox_config_plugin.change_config',
            'netbox_config_plugin.view_config'
        )

        instance = Config.objects.first()
        url = reverse('plugins:netbox_config_plugin:config_edit', kwargs={'pk': instance.pk})
    ...
    def test_delete_config(self):
        ...
        self.add_permissions(
            'netbox_config_plugin.delete_config',
            'netbox_config_plugin.view_config'
        )

        instance = Config.objects.first()
        url = reverse('plugins:netbox_config_plugin:config_delete', kwargs={'pk': instance.pk})
