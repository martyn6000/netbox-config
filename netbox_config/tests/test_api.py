...
class ConfigAPITestCase(PluginAPITestCase):
    ...
    def setUp(self):
        """Set up each test."""
        super().setUp()
        self.list_url_name = 'plugins-api:netbox_config-api:config-list'
        self.detail_url_name = 'plugins-api:netbox_config-api:config-detail'
    ...
    def test_create_config(self):
        ...
        self.add_permissions('netbox_config.add_config')
    ...
    def test_update_config(self):
        ...
        self.add_permissions('netbox_config.change_config')
    ...
    def test_delete_config(self):
        ...
        self.add_permissions('netbox_config.delete_config')
