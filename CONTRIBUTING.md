...
NetBox Config Plugin could always use more documentation, whether as part of the
official NetBox Config Plugin docs, in docstrings, or even on the web in blog posts,
articles, and such.
